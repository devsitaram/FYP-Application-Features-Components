...
fun GameScreen(navController: NavHostController) {
    ...
    Surface(Modifier.fillMaxWidth()) {
        ...
        // get data from gameModelView class (threading)
        // CoroutineScope(Dispatchers.IO).async{} == LaunchedEffect(true){}
        LaunchedEffect(true) {
    ...
    LazyColumn {
        items(gameList.value.size) {
            Column(
                ...
                val imageUrl = rememberAsyncImagePainter(gameList.value[it].thumbnail ?: "image")
                Text(text = title)
                Image(
...
//@Preview
@Composable
fun GooglePlaySearchButton(playStoreSearchUrl: String, context: Context) {
    IconButton(
        onClick = {
            val webIntent = Intent(
                Intent.ACTION_VIEW,
        ...
        Row(
            ...
            Image(
                painter = painterResource(id = R.mipmap.img_google_play),
...
@Composable
fun YouTubeSearchButton(videoId: String, context: Context) {
    IconButton(
        onClick = {
            val intent = Intent(Intent.ACTION_VIEW)
            intent.data = Uri.parse("https://www.youtube.com/search?q=$videoId")
        ...
        Row(
            ...
            Image(
                painter = painterResource(id = R.mipmap.img_youtube),
